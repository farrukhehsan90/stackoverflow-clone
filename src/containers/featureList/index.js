      ...
      <div id="mainbar" className="user-main-bar pl24 pt24">
              ...
              <div className="avatar-card">
                <div className="avatar">
                  <Link
                    ...
                    to={`/users/${props.match.params.user}`}
                  >
                ...
                <div className="info-cell">
                  <div className="info">
                    ...
                    <div className="date">
                      <p>
                        user created &nbsp;-&nbsp;
                        {moment(user?.creation_date).fromNow(false)}
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="counts">
                      <div className="cells">
                        <div className="column-grid">
                          <div className="head">{answerCout}</div>
                          <div className="foot">answers</div>
                        </div>
                      </div>
                      <div className="cells">
                        <div className="column-grid">
                          ...
                          <div className="foot">questions</div>
                        </div>
                      </div>
                      <div className="cells">
                        <div className="column-grid">
                          <div className="head">{scoreCount}</div>
                          <div className="foot">score</div>
                        </div>
                      </div>
                      <div className="cells">
                        <div className="column-grid">
                          <div className="head ">{tags ? tags.length : 0}</div>
                          <div className="foot">tags</div>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="row-grid">
          <div className="grid-cell1">
            <div className="cell-layout">
              ...
              <div className="user-posts">
                <h3 className="">Top network posts</h3>
          ...
          {sortType === "questions" && (
            <div className="grid-cell2">
              <div className="top-tags">
                <h3 className="fw-bold">Top Questions</h3>
                <div className="top-tags-sec">
                  {questions &&
                    questions.map((post) => (
